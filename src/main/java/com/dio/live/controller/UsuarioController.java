...
public class UsuarioController {
    ...
    public ResponseEntity<Usuario> getJornadaByID(@PathVariable("idJornada") Long idUsuario) throws Exception {
    ...
    public Usuario updateJornada(@RequestBody Usuario usuario){
        return usuarioService.updateJornada(usuario);
    }

    @DeleteMapping("/{idUsuario}")
    public ResponseEntity deleteByID(@PathVariable("idJornada") Long idUsuario) throws Exception {
        try {
